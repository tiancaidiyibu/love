...
document.title += getDateDiff((new Date()).getFullYear() + '-' + ((new Date()).getMonth() + 1) + '-' + (new Date()).getDate(), '2020-05-30') + 1 + '天';
export default {
    name: 'app',
    components: {
        StyleEditor,
...
`
            ...
            currentMarkdown: '',
            fullMarkdown: `Ikki × Lucky
----

2020年05月28日。初次相遇。两人齐齐心动。  
2020年05月30日。有幸能与你在一起。    
2020年06月05日。咦。。。。初次相见。   
我们在一起已有 \`${getDateDiff((new Date()).getFullYear()+'-'+((new Date()).getMonth()+1)+'-'+(new Date()).getDate(),'2020-05-30') + 1}\` 天   
希望我们可以一直下去哦，365天，1000天，10000天.....一辈子。
...
> 【Screw the world×I have my dear Lucky】   
